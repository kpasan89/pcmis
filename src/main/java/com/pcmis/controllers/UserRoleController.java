...
public class UserRoleController implements Serializable {
    ...
    @EJB
    private com.pcmis.facades.UserRoleFacade ejbFacade;
    ...
    public UserRole getUserRole(java.lang.Long id) {
